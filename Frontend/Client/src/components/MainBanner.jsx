  ...
  return (
    <div className='relative'>
        ...
        md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
          ...
          max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-15'>Freshness You Can Truse,Saving You will Love!</h1>
          ...
          <div className='flex item-center mt-6 font-medium'>
            ...
            hover:bg-primary-dull transition rounded text-white cursor-pointer'>Shope Now
            <img className='md:hiddem transition group-focus:translate-x-1' src={assets.white_arrow_icon} alt="arrow" /></Link>
